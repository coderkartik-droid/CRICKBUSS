export default async function run(page) {
  ...
  const PAGES = [
    ...
    ["/dashboard/local/team/", "Teams"],
    ["/dashboard/local/player/", "Players"],
    ["/dashboard/local/ground/", "Grounds"],
    ["/dashboard/local/match/", "Matches"],
    ["/dashboard/local/tournament/", "Tournaments"],
